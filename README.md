...
You can create a new stream from any *Lua table*, provided that the table is an array indexed with consecutive numbers from 1 to n, containing no ```nil``` values.
